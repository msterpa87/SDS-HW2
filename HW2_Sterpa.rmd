...
```{r simulations, warning=FALSE, cache=TRUE, include=FALSE}
n_1 <- 100
n_2 <- 1000
M <- 40
k_max <- 8
...
# small and large names have been inverted (i.e. small result is actually on the large sample)
small.accuracy.table <- make.accuracy.table(large.result$best_k, k_max)
large.accuracy.table <- make.accuracy.table(small.result$best_k, k_max)
